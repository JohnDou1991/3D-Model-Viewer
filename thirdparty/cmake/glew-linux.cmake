...
ExternalProject_Add(
    ...
    COMMAND             cmake ${GLEW_DIR}/src/build/cmake all -DCMAKE_INSTALL_PREFIX:PATH=${INSTALL_DIR}/glew -DGLEW_USE_STATIC_LIBS=TRUE -DBUILD_SHARED_LIBS=FALSE -DBUILD_STATIC_LIBS=TRUE
    CMAKE_CACHE_ARGS
